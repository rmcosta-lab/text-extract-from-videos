# Conceito e especificação — text-extract-from-videos

> 🔒 **Locked spec.** Este documento é a especificação canônica do
> comportamento e das entregas da ferramenta. Mude-o de forma deliberada, não
> casual. A constituição do projeto vive em [`specs/`](specs/):
